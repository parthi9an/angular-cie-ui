      ...
      return {
        ...
        link: function (scope, elem/*, attrs */) {
          ...
          scope.$watch('data', function (newVal, oldVal) {
        	  // To clear old data when updating no data(Graph data)
        	  if (  (! newVal && !oldVal) || (! newVal.length && (oldVal && !oldVal.length)) 
        			  || (Array.isArray(newVal[0]) && (! newVal[0].length && (oldVal && !oldVal.length)))) return;
